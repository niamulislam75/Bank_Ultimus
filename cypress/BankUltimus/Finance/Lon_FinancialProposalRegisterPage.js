class Lon_FinancialProposalRegister {
    ...
    FinancialProposalRegister() {
        ...
        //cy.wait('@formReload');
        cy.get('#ctl00_contPlcHdrMasterHolder_LstxtForwardingRefNo').focus().type(dataFinancialProposalRegister.for_ref_no);
        ...
        cy.get('#ctl00_contPlcHdrMasterHolder_LstxtCustomerID').focus().type(dataFinancialProposalRegister.cus_ID);
        ...
        cy.wait(3000);
        cy.get('#ctl00_contPlcHdrMasterHolder_LstxtEconomicPurposeCodeSBS').type(dataFinancialProposalRegister.eco_sbs);
        //cy.wait(3000);
        ...
        cy.get('#ctl00_contPlcHdrMasterHolder_LstxtLimitAmount').type(dataFinancialProposalRegister.limit_Amount);
        cy.wait(3000);
        cy.get('#ctl00_contPlcHdrMasterHolder_LstxtLimitValidity').type(dataFinancialProposalRegister.limit_Validity);
        cy.wait(3000);
        cy.get('#ctl00_contPlcHdrMasterHolder_LstxtLimitValidity').type(dataFinancialProposalRegister.limit_Validity);
        ...
        cy.wait(3000);
        cy.get('#ctl00_contPlcHdrMasterHolder_LstxtACValidity').type(dataFinancialProposalRegister.duration);
        ...
        cy.wait(3000);
        cy.get('#ctl00_contPlcHdrMasterHolder_LstxtDepositNote').type(dataFinancialProposalRegister.remarks);
        ...
        cy.get('.ui-dialog-content', { timeout: 10000 })  // বা popup এর selector যেটা ঠিক
            ...
            .then((text) => {
                ...
                if (match) {
                    ...
                    // এখন চাইলে এটা ব্যবহার করতে পারো অন্য কোথাও                    
