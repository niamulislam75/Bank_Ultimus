...
import DemandDepositAccOpen from '../BankUltimus/Deposit/DemandDepositAccOpen'; // ES Module import 
...
import AccInquary from '../BankUltimus/Deposit/AccountInquaryPage'; // ES Module import
...
describe('Bank Ultimus', () => {
  ...
  // it('Step 2: Transaction', function () {
  //   const loginPage = new LoginPage();
  //   const menuSearch = new MenuSearch();
  //   const nftAuthorize = new NFTAuthorize();
  //   const ddtrfTrans = new DDTrfTrans();
  ...
  // });
  it('Step 2: Transaction Authorization & Balance Inquary', function () {
    const loginPage = new LoginPage();
    const menuSearch = new MenuSearch();
